...
/**
 * Class to hold a collection of Measures and allow dempster-shafer-operations.
 * Allows for adding Measures after initialisation with a certain size and accumulation of those measures.
...
public class DempsterHandler{
	 ...
	 * @return The first measure object
	 */
	 ...
	 * @return  if the List contains only 1s
	 */
	 ...
	 * @param entryValues the list to be checked
	 * @return if the List contains only 0s
	 */
